...
<br>
<p align="center">
  <a href="https://circleci.com/gh/nxenv/nxenv-scraper">
    <img src="https://img.shields.io/circleci/build/github/nxenv/nxenv-scraper/master.svg" alt="Build Status">
  </a>
  <a href="https://github.com/nxenv/nxenv-scraper/blob/master/LICENSE">
    <img src="https://img.shields.io/github/license/nxenv/nxenv-scraper.svg" alt="License">
  </a>
...
Nxenv Scraper requires nothing to run. It doesn't need any database or a service.
...
So you want to contribute to Nxenv Scraper and make an impact, we are glad to hear it. :heart_eyes:

Before you proceed we have a few guidelines for contribution that will make everything much easier.
We would appreciate if you dedicate the time and read them carefully:
https://github.com/nxenv/.github/blob/master/CONTRIBUTING.md
